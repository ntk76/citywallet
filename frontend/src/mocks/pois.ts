...
export const POIS: POI[] = [
  ...
  },
  {
    ...
    category: "food",
    location: { lat: 48.1285, lng: 11.5875 },
    walkMin: 12,
    distanceM: 920,
    openNow: true,
    indoor: true,
    priceLevel: 2,
    tags: ["bavarian", "beer", "traditional", "warm"],
    demand: 0.45,
    imageHue: 32,
    description: "Bavarian classics, Märzen on tap, and a proper Wirtshaus atmosphere near the Au.",
  },
  {
    id: "augustiner-braeustuben",
    name: "Augustiner Bräustuben",
    category: "food",
    location: { lat: 48.1309, lng: 11.5824 },
    walkMin: 14,
    distanceM: 1050,
    openNow: true,
    indoor: true,
    ...
    demand: 0.4,
    imageHue: 28,
    description: "Altbayerische Küche, Augustiner vom Holzfass und gemütliche Bräustuben-Stimmung.",
  },
  {
